...
module.exports="/dist/850c0b4ea576d1501190a65ef677b6c0.png";
...
if (module.hot) {
  (function () {
    ...
    hotAPI.install(require("vue/dist/vue.esm.js"), true);
    if (!hotAPI.compatible) return;
    module.hot.accept();
    module.hot.dispose(__vueify_style_dispose__);
    if (!module.hot.data) {
      hotAPI.createRecord("data-v-a0fc1a44", __vue__options__);
    } else {
      hotAPI.reload("data-v-a0fc1a44", __vue__options__);
    }
  })();
}
},{"vueify/lib/insert-css":14,"./assets/logo.png":8,"vue-hot-reload-api":10,"vue/dist/vue.esm.js":12}],4:[function(require,module,exports) {
'use strict';
...
console.log('dada');
new _vueEsm2.default({
  el: '#app',
  render: function render(h) {
    return h(_App2.default);
  }
});
},{"vue/dist/vue.esm.js":12,"./App.vue":6}],0:[function(require,module,exports) {
var global = (1, eval)('this');
...
if (!module.bundle.parent && typeof WebSocket !== 'undefined') {
  var ws = new WebSocket('ws://localhost:51520/');
